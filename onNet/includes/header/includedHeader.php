      ...
      <header>
        <nav class="navbar_pr">
          <div class="navbar sticky">
            ...
            <div class="menu-btn" id="srsMenuBtn" style="background-image:url('<?php  echo get_stylesheet_directory_uri() . '/assets/img/header/hamburg\ bg.png'; ?>');">
            ...
            <ul class="menu-items">
              <li class="srs_first_child">
                <a href="#" class="menu-item first-item expand-btn">All courses
                  <img src="<?php echo get_stylesheet_directory_uri() . '/assets/img/header/arrow.png'; ?>" alt="arrow">
                </a>
                <div class="mega-menu sample">
                  ...
                  <div class="content">
                    ...
                    <div class="srs_brand_sec">
                      <img src="<?php echo get_stylesheet_directory_uri() . '/assets/img/header/UKRLP (3).webp'; ?>" alt="Brand">
                      <img src="<?php echo get_stylesheet_directory_uri() . '/assets/img/header/Group (6) (1).webp'; ?>" alt="Brand">
                      <img src="<?php echo get_stylesheet_directory_uri() . '/assets/img/header/Group 1000004280.webp'; ?>" alt="Brand">
                      <img src="<?php echo get_stylesheet_directory_uri() . '/assets/img/header/QLS_Logo_Colour 3 (1).webp'; ?>" alt="Brand">
              ...
              <li><a href="/hot-deal" class="menu-item first-item srs_hot_deals">
                  Hot Deals
                  <img src="<?php echo get_stylesheet_directory_uri() . '/assets/img/header/fire_1f525.png'; ?>" alt="arrow">
              ...
              <!-- <form id="search" class="menu-item first-item srs_search_field" action="">
                ...
                <button type="submit" class="sbtn">
                  <img src="<?php echo get_stylesheet_directory_uri() . "/assets/img/header/Vector (13).svg" ?>" alt="search">
                </button>
              </form> -->
            </ul>
            <ul class="cart_login_part">
              ...
              ?>
                ...
                <li class="log_btn"><a href="<?php bp_loggedin_user_link(); ?>" class="smallimg vbplogin">
                    <span>
                      <img src="<?php echo get_stylesheet_directory_uri() . '/assets/img/header/Group 1000004727.png'; ?>" alt="user">
                ...
                ?>
                  <li><a class="smallimg vbpcart"><span class="">
                        <img src="<?php echo get_stylesheet_directory_uri() . '/assets/img/header/cart2.svg'; ?>" />
              ...
              ?>
                ...
                <li class="log_btn"><a href="#login" rel="nofollow" class=" vbplogin"><span><img src="<?php echo get_stylesheet_directory_uri() . '/assets/img/header/Group 1000004727.png'; ?>" alt="user">
                ...
                if (in_array('woocommerce/woocommerce.php', apply_filters('active_plugins', get_option('active_plugins')))  || (function_exists('vibe_check_plugin_installed') && vibe_check_plugin_installed('woocommerce/woocommerce.php')) && $show_cart) {
                  global $woocommerce;
                ?>
                  <li><a class=" vbpcart"><span class=""><img src="<?php echo get_stylesheet_directory_uri() . '/assets/img/header/cart2.svg'; ?>" /> <?php echo (($woocommerce->cart->cart_contents_count) ? '<em>' . $woocommerce->cart->cart_contents_count . '</em>' : ''); ?></span></a>
          ...
          <div class="srs_mobile_mega">
            <div class="srs_mega_menu_item_pr">
              <div class="srs_heading_sec">
                <h4 class="srs_mega_heading">Popular Courses</h4>
                <img width="16" height="16" class="srs_cross" src="<?php echo get_stylesheet_directory_uri() . '/assets/img/header/cross.png'; ?>" alt="cross">
              </div>
              <ul class="srs_mega_menu_items">
                <?php foreach ($terms as $term) : ?>
                  <li>
